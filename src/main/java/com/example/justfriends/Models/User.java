...
public class User {
    ...
    public List<Group> getGroupsOwned(){return groupsOwned;}
    public List<Group> getGroupsAMemberOf(){return groupsAMemberOf;}
    ...
    public void setGroupsOwned(List<Group> groupsOwned){this.groupsOwned = groupsOwned;}
    public void setGroupsAMemberOf(List<Group> groupsAMemberOf){this.groupsAMemberOf = groupsAMemberOf;}
